<?php
  ...
  $surat = query("SELECT*FROM surat ORDER BY id_surat ASC");
      ...
      <div class="row mt-5 g-0 gass">
        ...
        <div class="col-sm-2 bg-dark mt-2 pt-4">
          <ul class="nav flex-column mb-5 sidebar list-unstyled ps-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-white rounded sidebar-active" href="surat.php" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tampil Data Surat">Data Surat</a><hr class="bg-secondary">
            </li>
            <li class="nav-item">
        ...
        <div class="col-sm-10 pt-5 content-icon">
          <!-- Membuat Konten Dashboard -->
           <h3><i class="bi bi-people icon"></i> Data Surat</h3><hr>
            ...
            <div class="card bg-success" style="width: 30rem; height:13rem;">
                <div class="card-body">
                  ...
                  <div class="display-4 fw-bold mt-3">
                    <?php 
                      $ambil = "SELECT count(*) AS jumlah FROM surat";
              ...
              <div class="input-group mb-3 ms-0 ps-0 mt-3">
                ...
                <div class="col-auto">
                <a type="submit" href="export_surat.php" class="btn btn-primary mb-3 px-5" name="export" >Download</a>
                </div>
              </div>
