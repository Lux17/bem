<?php
  ...
  $bidang = query("SELECT*FROM bidang ORDER BY idbidang ASC");
      ...
      <div class="row mt-5 g-0 gass">
        ...
        <div class="col-sm-10 pt-5 content-icon">
          <!-- Membuat Konten Dashboard -->
           <h3><i class="bi bi-music-note-beamed icon"></i> Data Bidang</h3><hr>
            ...
            <div class="card bg-danger" style="width: 30rem; height:13rem;">
                <div class="card-body">
                  ...
                  <div class="display-4 fw-bold mt-3">
                    <?php 
                      $ambil = "SELECT count(*) AS jumlah FROM bidang";
