<?php
  ...
  $pengurus = query("SELECT*FROM pengurus ORDER BY idpengurus ASC");
...
<html>
  <head>
    ...
    <title>Pendataan BEM FT UMC</title>
  </head>
      ...
      <div class="row mt-5 g-0 gass">
        ...
        <div class="col-sm-2 bg-dark mt-2 pt-4">
          <ul class="nav flex-column mb-5 sidebar list-unstyled ps-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-white rounded sidebar-active" href="pengurus.php" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tampil Data Pengurus"> Data Pengurus</a><hr class="bg-secondary">
            </li>
            <li class="nav-item">
        ...
        <div class="col-sm-10 pt-5 content-icon">
          ...
          <h3><i class="bi bi-person icon"></i> Data Pengurus</a></h3><hr>
          
          <div class="row ms-1 me-0 pe-0 text-white">
            <div class="card bg-primary" style="width: 30rem; height:13rem;">
                <div class="card-body">
              ...
              <div class="input-group mb-3 ms-0 ps-0 mt-3">
                ...
                <div class="col-auto">
                <a type="submit" href="export_pengurus.php" class="btn btn-primary mb-3 px-5" name="export" >Download</a>
                </div>
              </div>
