...
?>
    ...
    <h2> Buat Blog </h2>
		<form action="create_blog.php" method="post">
			<input type="text" name="title" class="form-control" placeholder="Judul Blog" class="in">
            <br>    
            
            <br>
           
			<input type="text" name="file" class="form-control" placeholder = "Masukan Link Foto" required="" class="in">
            <br><br>
            <input type="date" name="date" class="form-control" placeholder="date" class="in" required="" value="<?php echo tanggal_indonesia(date('Y-m-d'));?>">
            <div id="container">
