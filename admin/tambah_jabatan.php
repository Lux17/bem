<?php 
  ...
  $jabatan = query("SELECT*FROM jabatan ORDER BY idjabatan DESC");
      ...
      <div class="row mt-5 g-0 gass">
        ...
        <div class="col-sm-2 bg-dark mt-2 pt-4">
          <ul class="nav flex-column mb-5 sidebar list-unstyled ps-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-white rounded  sidebar-active" href="tambah_jabatan.php" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tambah atau Edit Data Jabatan"> Edit Data Jabatan</a><hr class="bg-secondary">
            </li>
            <li class="nav-item">
        ...
        <div class="col-sm-10 pt-5 content-icon">
          ...
          <h3><i class="bi bi-person-plus icon"></i> Tambah Data Jabatan</h3><hr>
          
          <div class="row me-0 pe-0">
            <form action="" method="POST">
            <div class="mb-3">
                <label for="idjaabtan" class="form-label d">Idjabatan :</label>
                <input type="text" class="form-control" id="idjabatan" name="idjabatan">
              </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="edit_jabatan.php?idjabatan=<?php echo $team["idjabatan"];?>" class="bg-success decor text-white ps-1 pt-1 pb-1 me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit">
                        <i class="bi bi-pencil-square"></i>
                    </a> 
                    <a href="hapus_jabatan.php?idjabatan=<?php echo $team["idjabatan"];?>" class="bg-danger decor text-white p-1" onclick="return confirm('Apakah anda yakin data akan dihapus?')" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Hapus">
